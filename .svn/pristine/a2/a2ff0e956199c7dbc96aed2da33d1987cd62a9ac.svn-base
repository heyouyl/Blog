	  ...
	  <nav class="navbar navbar-default" id="navbar">
	    <div class="container">
	      <div class="header-topbar hidden-xs link-border">
	        ...
	        <#if null==userlog>
	        	<a data-toggle="modal" data-target="#loginModal" class="login" rel="nofollow">Hi,请登录</a>&nbsp;&nbsp;<a href="${contextPath}user/login.html?action=register" class="register" rel="nofollow">我要注册</a>&nbsp;&nbsp;<a href="${contextPath}user/login.html?action=lostpassword" rel="nofollow">找回密码</a> 
	      	<#else>
