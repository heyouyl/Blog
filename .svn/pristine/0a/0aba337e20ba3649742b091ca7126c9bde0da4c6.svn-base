...
<title>回收站评论</title><link href="${contextPath}liger/lib/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" /> 
    ...
    <script type="text/javascript">   
        ...
        { 
            g = manager = $("#maingrid").ligerGrid({
                ...
                dataAction:'server',
                url:"commensdata.do?iden=trash&method=getUserPaging&privilege=-1",
                usePager:true,
				pageSize:10,
                width: "100%"
            });
...
<a class="l-button" style="width:120px" onclick="getSelected('-2')">放进垃圾评论</a>
