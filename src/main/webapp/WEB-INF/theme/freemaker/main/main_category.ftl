      ...
      <#assign x=1 />
		...
		<nav class="pagination" style="display: none;">
			...
			<#if page == 1>
				<li class="prev-page"></li>
			<#else>
				<li class="prev-page"><a href="?page=${contextPath}${urliden}/${article.get(0).slug}/page/${page?number-1}.html">上一页</a></li>
			</#if>
			...
			<#else>
				<#if pagebegin == 1>
					<li><a href="${contextPath}${urliden}/${article.get(0).slug}/page/1.html">1</a></li>
					<#if pages?number != 1>
						<#assign pagebegin=pagebegin+1 />
					</#if>
				<#else>
			...
			<#list pagebegin?number..pageend?number as k>
				<#if pages!=1>		
					...
					<#else>
						<li><a href="${contextPath}${urliden}/${article.get(0).slug}/page/${k}.html">${k}</a></li>
					</#if>
				</#if>
			</#list>
			...
			<#else>
				<li><span>...</span></li>
				<li class="next-page"><a href="${contextPath}${urliden}/${article.get(0).slug}/page/${page?number+1}.html">下一页</a></li>
			</#if>
