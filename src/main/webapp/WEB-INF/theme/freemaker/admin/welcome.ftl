...
<head>
    <title></title>
    <script src="../liger/lib/jquery/jquery-1.9.1.js" type="text/javascript"></script> 
...
<body style="background: white; font-size: 12px;"> 
 <input type="button" onClick="f_addTabItem('http://www.028888.net','fsdf')" value="fname" />
 <a class="l-link" href="javascript:f_addTabItem('demos/case/week.htm','fsdfdf')">工作日志</a>  
    <h2>
        欢迎使用Liger UI框架</h2>
