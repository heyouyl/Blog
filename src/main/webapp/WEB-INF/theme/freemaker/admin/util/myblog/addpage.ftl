...
<body style="padding:10px">
	<#if updataar['arid']??>
		<form name="form1" method="post" action="${contextPath}admin/update/addeditpage.do" id="form1">
	<#else>
    	<form name="form1" method="post" action="${contextPath}admin/update/addpage.do" id="form1">
    </#if>
<div>${adfefd}
</div>
